...
class DAGANDataset(object):
    def __init__(self, batch_size, last_training_class_index, reverse_channels, num_of_gpus, gen_batches,
        ...
        print('self.training_data_size', self.training_data_size)
...
class animalsDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        ...
        # ##### few-shot training
        # self.x = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDcombinedDx1x2/dataset_forquality/Augmented_128.npy")
        # # self.x = np.load("./EVALUATION/Augmentednpy/selectanimalsTrainselectTest/MSDMMD/dataset_forquality/Augmented_128.npy")
        # # self.x = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDAdversarial/dataset_forquality/Augmented_128.npy")
        # self.x = self.x / 255
...
class SelectMOREanimalsDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        # self.x = np.load("./Augmentednpy/dataset/animals_35.npy")
        # self.x = np.load("./Augmentednpy/dataset_forquality/animals_100.npy")
        # self.x = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDGMMD/dataset_forquality/Augmented_128.npy")
        # self.x = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDGMMD/dataset_forquality/Augmented_128.npy")
        # self.x = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDAdversarial/dataset_forquality/Augmented_128.npy")
        # self.x = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDMMD/dataset_forquality/Augmented_128.npy")
        self.x = np.load("./EVALUATION/Augmentednpy/SelectMOREanimals/MSDcombinedDx1x21/dataset_forquality/Augmented_350.npy")
        print('fake data shape', np.shape(self.x))
        self.x = self.x / 255
        x_train, x_val, x_test = self.x[:], self.x[:], self.x[:]
        return x_train, x_test, x_val

# data = flowersDAGANDataset(batch_size=1, last_training
