...
class DAGANDataset(object):
    ...
    def get_batch(self, dataset_name):
        ...
        if self.is_training > 0:
            ...
            # testing_num = 10
            # training_dataset = self.datasets[dataset_name][:self.selected_classes, testing_num:]
            # testing_number = int(self.general_classification_samples * 0.4)
            # testing_dataset = self.datasets[dataset_name][:self.selected_classes, :testing_num]
            ...
            training_dataset = [ self.datasets[dataset_name][i][testing_num:] for i in range(self.selected_classes)]
            testing_dataset =  [ self.datasets[dataset_name][i][:testing_num] for i in range(self.selected_classes)]
            ...
            # print('few-shot-class', few_shot_classes)
            ...
            # print('datashape',np.shape(training_dataset))

            for i in range(self.batch_size):
                # choose_classes = np.random.choice(np.shape(training_dataset)[0], size=self.selected_classes)
                ####fixed
                choose_classes = np.array( [i for i in range(self.selected_classes)] )
                # print(choose_classes)
                # print('class', choose_classes)
                for j in range(self.selected_classes):
                    ###testing data
                    # print('iterms',testing_dataset[choose_classes[j]].shape[0])
