...
class ResBlock(tf.keras.layers.Layer):
    def __init__(self, channels_in, channels_out, normalize=False, downsample=False, use_bias=True, sn=False, name='ResBlock'):
        ...
        self.conv_0 = Conv(self.channels_in, kernel=1, stride=1, pad=1, use_bias=self.use_bias, sn=self.sn, name='conv_0')
        self.ins_norm_0 = InstanceNorm(name='instance_norm_0')

        self.conv_1 = Conv(self.channels_out, kernel=1, stride=1, pad=1, use_bias=self.use_bias, sn=self.sn, name='conv_1')
...
class AdainResBlock(tf.keras.layers.Layer):
    def __init__(self, channels_in, channels_out, upsample=False, use_bias=True, sn=False, name='AdainResBlock'):
        ...
        self.conv_0 = Conv(self.channels_out, kernel=1, stride=1, pad=1, use_bias=self.use_bias, sn=self.sn, name='conv_0')
