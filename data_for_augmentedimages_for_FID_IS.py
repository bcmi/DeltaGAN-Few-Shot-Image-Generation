...
class animalsDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        ...
        self.x_generated = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDAdversarial/dataset_forquality/Augmented_128.npy")
        self.x =  np.load("../Matching-DAGAN-1wayKshot/datasets/animals_3_100_3_100_data.npy")
        self.x_real = self.x[85:]
        self.x_generated = self.x_generated / 255
        self.x_real = self.x_real / 255
        x_train, x_val, x_test = self.x[:], self.x[:], self.x[:]
        return  x_train, x_val, x_test, self.x_generated, self.x_real
...
class SelectMOREanimalsDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        ...
        self.x_generated = np.load("./EVALUATION/Augmentednpy/selectanimals/MSDMMD/dataset_forquality/Augmented_128.npy")
        self.x =  np.load("../Matching-DAGAN-1wayKshot/datasets/animals_3_100_3_100_data.npy")
        self.x_real = self.x[85:]
        self.x_generated = self.x_generated / 255
        self.x_real = self.x_real / 255
